...
vi.mock('@/features/auth/lib/me', () => ({
  getMe: vi.fn().mockResolvedValue({ vision_enabled: false, folder_icons_enabled: true, ai_categorisation_enabled: false, ai_categorisation_count_this_month: 0 }),
}))
...
describe('FolderSidebar folder icons', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(getMe).mockResolvedValue({ vision_enabled: false, folder_icons_enabled: true, ai_categorisation_enabled: false, ai_categorisation_count_this_month: 0 })
  })
  ...
  it('renders no icons when folder_icons_enabled is false', async () => {
    vi.mocked(getMe).mockResolvedValue({ vision_enabled: false, folder_icons_enabled: false, ai_categorisation_enabled: false, ai_categorisation_count_this_month: 0 })
    vi.mocked(getFolders).mockResolvedValue([makeFolder('1')])
