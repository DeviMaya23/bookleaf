...
Multi-select mode for the gallery on fine-pointer devices, allowing users to select multiple images via click and shift-click and act on them in bulk via the right panel's selection-actions mode.
