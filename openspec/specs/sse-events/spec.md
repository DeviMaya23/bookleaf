...
TBD — covers the Server-Sent Events (SSE) infrastructure used to push real-time notifications from the backend to connected frontend clients, starting with AI categorisation completion events.
