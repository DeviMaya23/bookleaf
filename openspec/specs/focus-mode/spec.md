...
Focus mode is a session-only UI state that hides the left sidebar and right
panel to give the gallery and image viewer the full viewport width, toggled
via a "Focus" button in the gallery toolbar and image viewer header.
