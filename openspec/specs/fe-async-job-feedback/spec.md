...
After a successful image upload, the frontend provides live feedback for async background jobs: thumbnail generation polling and vision-based folder suggestion delivery.
