...
The public landing page at `/` introduces unauthenticated visitors to Bookleaf, presenting a nav bar, hero section, features section, and footer within a single non-scrollable viewport, and provides entry points into the Kinde-hosted sign-in flow.
