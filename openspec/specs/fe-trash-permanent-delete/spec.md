...
Defines the permanent deletion capabilities in the trash view: deleting a single trashed image via the context menu, and emptying the entire trash via the sidebar context menu.
