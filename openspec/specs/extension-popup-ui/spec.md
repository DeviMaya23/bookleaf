...
- A footer with a "Log out" text button aligned to the right
...
- **THEN** the popup shows the logged-in layout with header, user row, recently saved section, and footer
...
#### Scenario: Log out clears auth and transitions to logged-out state
