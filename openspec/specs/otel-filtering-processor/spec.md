# otel-filtering-processor Specification

## Purpose
Defines the `filteringProcessor` span processor that applies ratio-based sampling at the processor layer, forwarding error spans unconditionally and probabilistically sampling non-error spans by hashing the trace ID.
