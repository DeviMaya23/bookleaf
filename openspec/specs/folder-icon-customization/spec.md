## Purpose
Define icon customization for user folders and fixed icons for system sidebar entries, including the icon allowlist, the change-icon UI, and the per-user toggle to show or hide icons in the sidebar.
