...
Interactive transform behaviour for the full-resolution image viewer: fit-on-open scaling, mouse wheel zoom, drag-to-pan, rotation, horizontal flip, two-way zoom slider sync, 1:1 reset, and transform reset when the viewed image changes.
