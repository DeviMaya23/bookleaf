# Spec: Extension In-Page Toast

## Purpose

Defines the requirements for the browser extension's in-page toast notification system. Instead of using the browser's native notifications API, the extension renders toast messages directly within the active tab's page using a content script and Shadow DOM isolation.
