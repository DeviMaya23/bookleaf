...
Defines the `GET /images`, `GET /images/:id`, `GET /images/trash`, and related image-listing/mutation HTTP endpoints — their request/response shapes, query parameter validation, and the repository/usecase interfaces backing them.
