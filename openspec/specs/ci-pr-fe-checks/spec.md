...
## Purpose
Defines the GitHub Actions CI workflow for frontend pull request checks, covering path-filtered triggering, Node.js setup with caching, linting, unit testing, and TypeScript build validation.
