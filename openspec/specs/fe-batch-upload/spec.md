...
This spec covers the batch upload capability, providing a `BatchUploadModal` component that allows users to upload multiple images in a single action with per-file progress tracking, validation, and retry support.
