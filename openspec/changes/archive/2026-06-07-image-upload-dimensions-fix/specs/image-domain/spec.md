...
- `Width` — image width in pixels, nullable; supplied by the client and persisted at upload completion (`width`)
- `Height` — image height in pixels, nullable; supplied by the client and persisted at upload completion (`height`)
- `FileSize` — file size in bytes, nullable; supplied by the client and persisted at upload completion (`file_size`)
