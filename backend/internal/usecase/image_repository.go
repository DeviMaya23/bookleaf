...
type ImageRepository interface {
	...
	List(ctx context.Context, userID uuid.UUID, unfiled bool, folderIDs []uuid.UUID, tagIDs []uuid.UUID, mimeTypes []string, name *string, searchLabels bool, sortField *string, direction *string, cursor *ImageCursor, limit int) ([]*domain.Image, error)
	...
	Update(ctx context.Context, id uuid.UUID, userID uuid.UUID, fields map[string]any) (*domain.Image, error)
